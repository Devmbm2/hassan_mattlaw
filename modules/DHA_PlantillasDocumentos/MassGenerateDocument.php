			...
			<div class="modal-dialog" style="max-height: 1350px; width: 90%;">
				<div class="modal-content" style="height: 550px;max-width: 1350px;width: 90%;">
					...
					<div class="modal-body" style= "height: 73%;">
                        ...
                        <div class="col-xs-4 col4 select_area" id="contactrole_list_section" style="display: none;">
                <div class="title">Select Contact Role</div>
                <select id="contactrole_list" name="contactrole_id">
                </select>
            </div>
					...
					<div class="modal-footer">
						<label><input type="checkbox"  name="AttachGeneratedDocumentToRecord" id="AttachGeneratedDocumentToRecord_detailview" value="1" checked="checked" disabled>&nbsp; Attach Document with Record &nbsp;</label>
						<button type="button" class="btn btn-default" id="document_generation_form_submission_btn"  onclick="document_generation_form_submission();" disabled>Generate Document</button>
