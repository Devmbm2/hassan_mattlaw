...
class AOK_KnowledgeBaseViewEdit extends ViewEdit
{
    ...
    function displayTMCE(){
        ...
        $("#multiple_assigned_users").parent().append('<input id="chkall" type="checkbox" >Select All');
        $("#chkall").click(function(){
        if($("#chkall").is(':checked')){
            $("#multiple_assigned_users > option").prop("selected", "selected");
            $("#multiple_assigned_users").trigger("change");
        } else {
            $("#multiple_assigned_users > option").removeAttr("selected");
            $("#multiple_assigned_users").trigger("change");
        }
    });
		</script>
