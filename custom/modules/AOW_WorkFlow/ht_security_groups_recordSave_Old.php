	...
	if ($count == 0 )
			 { 
			 	if($bean->assigned_type == 'Team'){
			 		$sql2 = "INSERT into securitygroups_records VALUES (uuid(),'".$bean->assigned_team."','".$bean->id."','AOW_Workflow','".$bean->date_modified."','".$bean->modified_user_id."','".$bean->created_by."',0)";
