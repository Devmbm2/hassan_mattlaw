...
if (search_value2.length >= 1) {
	$.ajax({
		url:"index.php?module=Contacts&action=index&return_module=Contacts&return_action=DetailView&clear_query=true&filter_module=" + search_value2,
		type: "post",
		data: {search_contact:search_value2},
