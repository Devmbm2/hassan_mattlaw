	 ...
	 $(document).ready(function(){
		...
		$('#search').on( 'keyup', function () {
			...
			if (search_value2.length >= 1) {
				//console.log(search_value2.length)
				$.ajax({
					url:"index.php?module=Accounts&action=index&return_module=Accounts&return_action=DetailView&clear_query=true&filter_module=" + search_value2,
					type: "post",
					data: {accounts_live_search:search_value2},
					success:function(result){
						console.log($(result).find("#tbody_id > tr"));
