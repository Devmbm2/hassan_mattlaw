...
class AccountsHook{
    public function saveToContacts($bean, $event, $arguments){
        ...
        $sql = "INSERT INTO contacts (id, salutation, first_name, last_name, dear_c, phone_mobile, phone_work, phone_fax,primary_address_street,primary_address_city,primary_address_state,primary_address_postalcode,primary_address_country,description)
                    VALUES ('$id','Honorable', '$name', '$name', '$name', '$phone_office', '$phone_office', '$phone_fax','$billing_address_street','$billing_address_city','$billing_address_state','$billing_address_postalcode','$billing_address_country','$description')";
