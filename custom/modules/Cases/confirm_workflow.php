   ...
   // foreach($all_actions_related_to_workflow as $action){ 
     $form.='
      <tr>
        ...
        foreach($all_actions_related_to_workflow as $action){
     $form .= '<li>'.$action->name.'</li>';
     }
      $form .= '</ol></td><td><a href="#" style="color:#edd03d;" onclick="ShowDescription(\''.$workflow_bean->description.'\')"><i class="fa fa-info-circle" aria-hidden="true"></i></a></td>
