            ...
            success: function (result) {
                if (result !== 'false') {
                    ...
                    Object.entries(result).forEach(([key, v]) => {
                        ...
                        $("#statue_body").append('<tr class="trclass"><td><input name="case_type[]" value=' + v.case_type + ' readonly id="case_type" style="font-weight: bold; font-size:15px; width: 350px;"></td><td><select class="' + sol_time_class + '" name = "sol_time[]" id="sol_time"><option value="' + v.sol + '" selected>' + v.sol + '</option></select></td><td><select name = "sol_category[]" id="sol_category"><option value="' + v.sol_category + '" selected>' + v.sol_category + '</option></select></td></tr>');
