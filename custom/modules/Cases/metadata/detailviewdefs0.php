    ...
    array (
      ...
      array (
        ...
        array (
          ...
          10 =>
          array (
              'customCode' => '<input type="button" onclick="window.open(\'index.php?&module=Cases&action=relatedDocuments&record={$fields.id.value}\')" target="_blank" value="Related Documents" />',
          ),
          // 11 =>
          // array (
          //   'customCode' => '<input type="button" onclick="send_document_to_multi_contact();" target="_blank" value="Send Document To Multiple Contacts" />',
          // ),
          // 12 =>
          // array (
          //     'customCode' => '<input type="button" onclick="window.open(\'index.php?&module=Cases&action=case_reports&record={$fields.id.value}\')" target="_blank" target="_blank" value="Custom Reports" />',
          // ),
          13 => 
          array (
    ...
    'lbl_workflow_status_panel' => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            'name' => 'attorney_duration_hours_c',
            'label' => 'LBL_ATTORNEY_DURATION_HOURS',
          ),
          1 => 
          array (
            'name' => 'attorney_duration_minutes_c',
            'studio' => 'visible',
            'label' => 'LBL_ATTORNEY_DURATION_MINUTES',
          ),
        ),
        1 => 
        array (
          0 => 
          array (
            'name' => 'paralegal_duration_hours_c',
            'label' => 'LBL_PARALEGAL_DURATION_HOURS',
          ),
          1 => 
          array (
            'name' => 'paralegal_duration_minutes_c',
            'label' => 'LBL_PARALEGAL_DURATION_MINUTES',
          ),
        ),
        2 => 
        array (
          0 => 
          array (
            'name' => 'legal_assistant_duration_hours_c',
            'label' => 'LBL_LEGAL_ASSISTANT_DURATION_HOURS',
          ),
          1 => 
          array (
            'name' => 'legal_assistant_duration_minutes_c',
            'label' => 'LBL_LEGAL_ASSISTANT_DURATION_MINUTES',
          ),
        ),
        3 => 
        array (
          0 => 
          array (
            'name' => 'document_duration_hours_c',
            'label' => 'LBL_DOCUMENT_DURATION_HOURS',
          ),
          1 => 
          array (
            'name' => 'document_duration_minutes_c',
            'label' => 'LBL_DOCUMENT_DURATION_MINUTES',
          ),
        ),
      ),
    ),
