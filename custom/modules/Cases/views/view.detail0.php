...
protected function _displaySubPanels()
	...
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['defendant_insurance']['order'] = 9;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['def_defendants_cases']['order'] = 10;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['disc_discovery_cases']['order'] = 11;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['emails']['order'] = 12;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['cases_fp_events_1']['order'] = 13;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['hard_documents']['order'] = 14;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['investigation']['order'] = 15;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['neg_negotiations_cases']['order'] = 16;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['history']['order'] = 17;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['accounts']['order'] = 18;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['plea_pleadings_cases']['order'] = 19;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['project']['order'] = 20;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['securitygroups']['order'] = 21;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['soft_documents']['order'] = 22;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['activities_done']['order'] = 23;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['activities']['order'] = 24;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['activities_overdue']['order'] = 25;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['activities_skipped']['order'] = 26;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['transcripts_statements']['order'] = 27;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['trail_documents']['order'] = 28;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['def_client_insurance_cases_1']['order'] = 29;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['ht_vehicles_cases_1']['order'] = 30;
	$subpanel->subpanel_definitions->layout_defs['subpanel_setup']['get_case_workflows']['order'] = 31;
