...
{*    {=======To show Dropdowns========}*}
    <form method="Post" action="javascript:void(0);" id="report_form_c" autocomplete="off">
            <div class="row">
            <div class="col-sm-12">
    ...
    <div class="row">
       ...
       <button type="submit" onclick="ganratePDF();" id="pdf_btn_c" name="button" class="button primary generate_pdf" style="font-size: 10px; color:black;width:170px;">Generate Pdf</button>
       <button onclick="generateGraph();" style="font-size: 10px; color:black;width:170px;" id="ViewGraph" class="button primary"  style="font-size: 10px;">View Graph</button>
       <button onclick="return false;" id="pdfgraph" class="button primary"  style="font-size: 10px; color:black;">Generate Graph</button>
       <button onclick="ClearPage();" name="Clear" class="button primary"  style="font-size: 10px; color:black;width:90px;" type = "button">Clear</button>
               </div>
          </div>
